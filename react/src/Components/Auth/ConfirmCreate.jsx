...
Your have successfully created <br className='md:hidden block '  /> a new password.
</h1>

<p  className=' text-center font-semibold text-base text-[#7E7E7E]'>
Sign in to your admin account to start  <br className='md:hidden block '  />operation!</p>
    </div>
