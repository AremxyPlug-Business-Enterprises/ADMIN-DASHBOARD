...
import userIcon from "../../assets/user icon square.svg";
...
const DeleteUser = () => {
  ...
  return (
    <DashboardLayout>
      <section className=" flex flex-col gap-7 w-full pb-10 relative">
...
{/* Modal */}
  ...
  absolute md:top-[50px] top-[70px] z-[2000] bg-white rounded-[20px]"
              style={{
...
<div className="bg-[#04177F] max-w-full h-[22px]"></div>
       ...
       text-[#F95252] text-center md:h-[38px] lg:w-[123px] w-full h-[44px] cursor-pointer"
        ...
        {showConfirm && (
          <div className="w-full flex items-center justify-center">
            <div
              className="lg:w-[840px] w-[98%] h-[465px] flex flex-col items-center justify-between gap-10 py-7
  absolute md:top-[50px] top-[70px] z-[2000] bg-white rounded-[20px]"
              style={{
                boxShadow: "0px 0px 20px 0px #00000040",
              }}
        ...
        <div className="flex flex-col gap-7 w-full">
          ...
          <h1 className="text-[#04177F] lg:text-[21px] lg:leading-[32px] font-medium">
            {" "}
            Delete User Account
          </h1>

          <div
            className="border-[1px] border-[#CBCBCB] max-w-[1247px] w-full h-[311px] flex items-center justify-start"
            style={{ boxShadow: " 0px 0px 7px 0px #00000040" }}
          >
            <form className="flex flex-col gap-5 lg: ml-7 lg:ml-15">
              <h1 className="text-[#9C9C9C] lg:text-[21px] lg:leading-[32px] font-medium">
                {" "}
                Email Address/ User Id / Username
              </h1>

              <input
                type="text"
                className="border-[1px] border-[#D0D5DD] bg-[#FAFDFF] 
      lg:w-max-w-[426px] w-full h-58px] py-[10px] px-[13px] rounded-[8px]"
                placeholder=""
              />
              ...
              <button
                ...
                className="border-[1px] border-[#D0D5DD] bg-[#04177F]  flex items-center justify-center cursor-pointer
        lg:w-max-w-[426px] w-full h-[58px] lg:py-[13px] lg:px-[27px] rounded-[8px]"
              >
                <h1 className="text-white lg:text-[21px] lg:leading-[32px] font-medium">
                  {" "}
                  Search
                </h1>
              </button>
