...
import userIcon from "../../assets/Cybersecurity and password authentication.png";
       ...
       absolute md:top-[270px] top-[180px] z-[2000] bg-white rounded-[20px]"
                 ...
                 >
                   ...
                   <div className="flex flex-col gap-5 w-full">
                     ...
                     <div className="bg-[#04177F] max-w-full h-[22px]"></div>
                   <h1 className="text-[#000000] lg:text-[21px] lg:leading-[32px] font-semibold text-center">
                   User Pin been reset successfully
                   </h1>
...
<h1 className="text-[#04177F] lg:text-[21px] lg:leading-[32px] font-medium"> Reset User Password</h1>
...
<h1 className="text-[#9C9C9C] lg:text-[21px] lg:leading-[32px] font-medium"> Enter Password</h1>
...
<h1 className="text-[#9C9C9C] lg:text-[21px] lg:leading-[32px] font-medium"> Confirm Password </h1>
